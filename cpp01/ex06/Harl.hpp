...
# define GENERAL_MSG "\
Coding in C is tedious, but at least I'm not writing Python, where every \n\
indentation error is a subtle reminder that whitespace has feelings. And \n\
don’t get me started on Python's 'dynamic typing'—because nothing says \n\
'professional' like a variable that can be an integer, a string, or a \n\
totally unexpected error at runtime. At least in C, my disasters are predictable!"
